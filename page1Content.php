...
echo"				<h1>WUDDUPwuddup doe</h1>
					...
					<h2>Mikey</h2>
					<h3>Mikey</h3>
					<h4>Ha I found a code I'm better than you at</h4>
					<h5>God, this is so much fun</h5>
					<h6>I love you, I'll show you everything.</h6>
					<hr>

					<!-- Paragraphs -->
					<h3>Paragraphs</h3>
					<p>basic paragraaph shit.</p?
					<hr>
